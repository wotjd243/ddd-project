...
public class DummyShippingData {
    ...
    static {
        put(1l    , ShippingStatus.SHIPPING_DONE.getValue(), "111-2323-4444", "분당점",
    ...
    private static Shipping put(final Long id, final String shippingStatus, String orderId, String position,
