...
public class DummyShippingData {
    ...
    static {
        put("1123-1111-1111"    , ShippingStatus.SHIPPING_DONE.getValue(), "111-2323-4444", "분당점",
    ...
    private static Shipping put(final String id, final String shippingStatus, String orderId, String position,
